...
def parse_arguments():
    ...
    parser.add_argument('--mode', type=int, help='Connection mode: 1 Talk, 2 Transport File')
...
def main():
    ...
    if received == b'Hey there!':
        ...
        print('The device is denied access to the server')
        sock.close()
        return
